...
public class NationalTeamTest {
	...
	public static void main(String[] args) {
		...
		//System.out.println(ratingTeam.getRegisteredPlayers().getPlayers()[2].getName());
		...
		if (Math.abs(ratingTeam.calculateRating() - expected) > DELTA) {
			System.err.println("TEST FAILED: Izracun tima nije dobar. Vaš je: " + ratingTeam.calculateRating() + "Treba biti: " + expected);
		}
